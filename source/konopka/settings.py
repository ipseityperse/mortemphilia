"""
Django settings for konopka.me project.
"""
...
SECRET_KEY = 'h(kw5lxsbzt!su2w-bg$)o%ky7go@_+bw__2-=e$jn8030ugbs'  # noqa: S105
...
WSGI_APPLICATION = 'konopka.wsgi.application'
